...
import com.capstone.notekeeper.QuizModule.Model.QuestionRandom;
...
public class QuizFinalActivity extends AppCompatActivity {
    ...
    public void showResult(){
        Intent intent = new Intent(QuizFinalActivity.this, ResultActivity.class);
        Bundle b = new Bundle();
