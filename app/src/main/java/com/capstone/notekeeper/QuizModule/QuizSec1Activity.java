...
import com.capstone.notekeeper.QuizModule.DbHelper.DbHelper;
import com.capstone.notekeeper.QuizModule.Model.QuestionCompFunda;
...
public class QuizSec1Activity extends AppCompatActivity {
    ...
    public void showResult(){
        Intent intent = new Intent(QuizSec1Activity.this, ResultActivity.class);
        Bundle b = new Bundle();
