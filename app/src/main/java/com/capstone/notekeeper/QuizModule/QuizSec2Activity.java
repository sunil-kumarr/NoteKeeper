...
import com.capstone.notekeeper.QuizModule.Model.QuestionOS;
...
public class QuizSec2Activity extends AppCompatActivity {
    ...
    public void showResult(){
        Intent intent = new Intent(QuizSec2Activity.this, ResultActivity.class);
        Bundle b = new Bundle();
